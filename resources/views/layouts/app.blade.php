...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/holla.css') }}">
    ...
    <link rel="icon"
        href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='red'><path d='M12 18c4 0 7-3 7-7 0-2-1-4-2-6-1-2-5-5-5-5S8 4 7 6c-1 2-2 4-2 6 0 4 3 7 7 7z'/></svg>">
...
<body>
    ...
    <!-- Navbar -->
    <header class="navbar"
        style="border-bottom: 4px solid red; display: flex; align-items: center; padding: 10px 0; background-color: white;">
        <div class="logo-name" style="display: flex; align-items: center;">
            ...
            <span class="logo-text" style="margin-left: 10px; font-weight: bold; color: #333; font-size: 1.2rem;">Pantau
                Darah .</span>
        </div>

        @auth
            <div class="bx bx-user"
                style="margin-left: auto; margin-right: 20px; display: flex; align-items: center; gap: 8px;">
